/**
 * Component that is used by the edit an EXISTING sample  
 ...
 * When saved, a the data is saved to an existing entry in the sample api
 */
 ...
 * Unlike the Create.js page, this save operation OVERWRITES an existing sample. 
 * This is differnet as an existing sample has an existing url, whereas a new sample does not. 
...
function SaveSample(saved_data) {
    ...
    function handleClick() {
        ...
        OverwriteSample(getInstrumentName(), name, Object.values(saved_data));
        alert("Saved Sample");
    }   
...
var dataReady = false; // used to control race conditions

/**
 * The main component of the Edit page
